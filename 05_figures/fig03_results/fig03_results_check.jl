...
# LOAD DATA
#-----------------------------------------------------------------------
DATA_DIR = joinpath("data", "regenerated_dataset");
x = CSV.read(joinpath(DATA_DIR, "sb21_09Feb25_test_x.csv"), DataFrame);
y = CSV.read(joinpath(DATA_DIR, "sb21_09Feb25_test_y.csv"), DataFrame);
...
with_theme(create_figure_theme()) do
    ...
    save(joinpath("05_figures", "fig03_results", "fig03_results_check.pdf"), fig)
    fig
end
