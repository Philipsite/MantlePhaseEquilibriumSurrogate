...
model_state = JLD2.load("models/classifier/saved_model.jld2", "model_state");
...
# TUNE IT
#-----------------------------------------------------------------------
hpt_regressor_pretrained_classifier(n_layers, n_neurons, fraction_backbone_layers[1], batch_size[1], loss,
                                    (x_train, (𝑣_train, 𝐗_ss_train)), (x_val, (𝑣_val, 𝐗_ss_val)),
                                    m_classifier, masking_f,
                                    1000, metrics,
                                    freeze_classifier=true,
                                    lr_schedule=false,
                                    subdir_appendix="ptClas_frozen_fbl1_bs1")

hpt_regressor_pretrained_classifier(n_layers, n_neurons, fraction_backbone_layers[1], batch_size[2], loss,
                                    (x_train, (𝑣_train, 𝐗_ss_train)), (x_val, (𝑣_val, 𝐗_ss_val)),
                                    m_classifier, masking_f,
                                    1000, metrics,
                                    freeze_classifier=true,
                                    lr_schedule=false,
                                    subdir_appendix="ptClas_frozen_fbl1_bs2")

hpt_regressor_pretrained_classifier(n_layers, n_neurons, fraction_backbone_layers[1], batch_size[3], loss,
                                    (x_train, (𝑣_train, 𝐗_ss_train)), (x_val, (𝑣_val, 𝐗_ss_val)),
                                    m_classifier, masking_f,
                                    1000, metrics,
                                    freeze_classifier=true,
                                    lr_schedule=false,
                                    subdir_appendix="ptClas_frozen_fbl1_bs3")

hpt_regressor_pretrained_classifier(n_layers, n_neurons, fraction_backbone_layers[2], batch_size[1], loss,
                                    (x_train, (𝑣_train, 𝐗_ss_train)),  (x_val, (𝑣_val, 𝐗_ss_val)),
                                    m_classifier, masking_f,
                                    1000, metrics,
                                    freeze_classifier=true,
                                    lr_schedule=false,
                                    subdir_appendix="ptClas_frozen_fbl2_bs1")

hpt_regressor_pretrained_classifier(n_layers, n_neurons, fraction_backbone_layers[2], batch_size[2], loss,
                                    (x_train, (𝑣_train, 𝐗_ss_train)),  (x_val, (𝑣_val, 𝐗_ss_val)),
                                    m_classifier, masking_f,
                                    1000, metrics,
                                    freeze_classifier=true,
                                    lr_schedule=false,
                                    subdir_appendix="ptClas_frozen_fbl2_bs2")

hpt_regressor_pretrained_classifier(n_layers, n_neurons, fraction_backbone_layers[2], batch_size[3], loss,
                                    (x_train, (𝑣_train, 𝐗_ss_train)),  (x_val, (𝑣_val, 𝐗_ss_val)),
                                    m_classifier, masking_f,
                                    1000, metrics,
                                    freeze_classifier=true,
                                    lr_schedule=false,
                                    subdir_appendix="ptClas_frozen_fbl2_bs3")
